    ...
    <section className="py-20 bg-gray-950">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center">
            {Array.from({ length: 6 }, (_, index) => (
              <div 
                key={index}
                className="aspect-video bg-gray-800/30 border border-gray-700/50 rounded-lg flex items-center justify-center hover:border-yellow-500/30 transition-colors"
              >
                <div className="text-center">
                  <div className="w-8 h-8 bg-yellow-500/20 rounded-lg mx-auto mb-2"></div>
                  <p className="text-gray-500 text-xs">Логотип {index + 1}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center space-x-12 bg-gray-900/50 border border-yellow-500/20 rounded-2xl px-8 py-6">
            <div>
            ...
            <div>
              ...
              <div className="text-sm text-gray-400 mt-1">повторных обращений</div>
            </div>
            <div className="w-px h-12 bg-gray-700"></div>
            <div>
